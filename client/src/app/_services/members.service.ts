...
export class MembersService {
  ...
  getMembers() {
    ...
    if (response) return this.pageinatedResponse(response);
    ...
    return this.http
      ...
      .subscribe({
        next: (response) => {
          this.pageinatedResponse(response);
  ...
  pageinatedResponse(response: HttpResponse<Member[]>) {
    this.pageinatedResult.set({
